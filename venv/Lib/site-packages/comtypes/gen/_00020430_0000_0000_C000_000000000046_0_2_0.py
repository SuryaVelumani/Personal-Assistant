...
IFontDisp = Font
__all__ = [ 'OLE_YSIZE_CONTAINER', 'OLE_YPOS_HIMETRIC', 'Default',
           'IFontDisp', 'Font', 'OLE_CANCELBOOL', 'Monochrome',
           'OLE_XPOS_CONTAINER', 'LoadPictureConstants',
           'OLE_YSIZE_PIXELS', 'StdFont', 'Unchecked',
           'OLE_YPOS_CONTAINER', 'FONTSIZE', 'OLE_XPOS_HIMETRIC',
           'OLE_HANDLE', 'FONTSTRIKETHROUGH', 'OLE_YSIZE_HIMETRIC',
           'IFontEventsDisp', 'FONTNAME', 'Gray', 'OLE_YPOS_PIXELS',
           'VgaColor', 'OLE_XSIZE_CONTAINER', 'IFont', 'OLE_COLOR',
           'IPicture', 'Picture', 'FONTITALIC', 'OLE_XPOS_PIXELS',
           'Checked', 'StdPicture', 'OLE_XSIZE_PIXELS',
           'FONTUNDERSCORE', 'IPictureDisp', 'FontEvents',
           'OLE_ENABLEDEFAULTBOOL', 'OLE_OPTEXCLUSIVE', 'FONTBOLD',
